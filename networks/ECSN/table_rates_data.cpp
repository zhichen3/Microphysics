...
namespace rate_tables
{
    ...
    AMREX_GPU_MANAGED Array3D<Real, 1, 39, 1, 152, 1, 6, Order::C> j_f20_o20_data;
    ...
    AMREX_GPU_MANAGED Array3D<Real, 1, 39, 1, 152, 1, 6, Order::C> j_ne20_f20_data;
    ...
    AMREX_GPU_MANAGED Array3D<Real, 1, 39, 1, 152, 1, 6, Order::C> j_o20_f20_data;
    ...
    AMREX_GPU_MANAGED Array3D<Real, 1, 39, 1, 152, 1, 6, Order::C> j_f20_ne20_data;
